...
Download and extract the DeloresDev engine executable from [here](https://grumpygamer.com/deloresdev). The engine executable can go anywhere.
...
If you want to hear audio and aren't interested in creating new audio, the Delores **FMOD** `.bank` files can be downloaded from [here](https://grumpygamer.com/deloresdev). Extract and place both `.bank` files in `DeloresDev/Sounds/`
...
## Wimpy
The tool to add and position objects is called **Wimpy** and it can be download [here](https://grumpygamer.com/deloresdev)
